...
{
	return [NSString stringWithFormat:@"BSKmlResult :\n	address : %@\n	countryNameCode : %@\n	countryName : %@\n	subAdministrativeAreaName : %@\n	localityName : %@\n	addressComponents : %@", address, countryNameCode, countryName, subAdministrativeAreaName, localityName, addressComponents];
}
